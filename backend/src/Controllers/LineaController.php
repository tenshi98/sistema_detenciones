...
class LineaController {
    ...
    */
    public function store(): void {
        ...
        if (!$this->lineaModel->validateUniqueNombre($data['Nombre'], $id ?? null)) {
        ...
        try {
            $id = $this->lineaModel->create($data);
    ...
    */
    public function update(int $id): void {
        ...
        try {
            $result = $this->lineaModel->update($id, $data);
    ...
    */
    public function destroy(int $id): void {
        try {
            $result = $this->lineaModel->delete($id);
    ...
    * ===================================================================
    * Activar
    * POST /lineas/{id}/activate
    */
    public function activate(int $id): void {
        try {
            $result = $this->lineaModel->activate($id);
